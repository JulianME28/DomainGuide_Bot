...
HELP = (
    ...
    "<b>💬 ШІ-консультант:</b> живий діалог із поясненнями, "
    "рекомендаціями та уточнювальними питаннями.\n"
    "<b>🧠 Індивідуальний запит:</b> ШІ аналізує нестандартну умову, "
    "перетворює її на безпечний фільтр або просить уточнення.\n\n"
    "<b>Команди:</b>\n"
    "/start — головне меню\n"
    "/help — ця довідка\n"
    "/magic — база Меджик\n"
    ...
    "/ai — індивідуальний запит до ШІ\n"
    "/chat — живий діалог з ШІ-консультантом\n"
