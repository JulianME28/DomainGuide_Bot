...
_RAW: tuple[tuple, ...] = (
    ...
    ("ua", "Україна", "Ukraine", (".ua", ".com.ua"), "uk", "🇺🇦", "europe",
     ("україн",), (), ("ukraine",), ()),
    # -------------------- СНД / пострадянські країни ----------------------
    ("ru", "Росія", "Russia", (".ru",), "ru", "🇷🇺", "europe",
     ("росі",), (), ("рф",), ("російська федерація",)),
    ("by", "Білорусь", "Belarus", (".by",), "be", "🇧🇾", "europe",
     ("білорус",), (), (), ()),
    ("md", "Молдова", "Moldova", (".md",), "mo", "🇲🇩", "europe",
     ("молдов", "молдаві"), (), (), ()),
    ("ge", "Грузія", "Georgia", (".ge",), "ka", "🇬🇪", "asia",
     ("грузі",), (), (), ()),
    ("am", "Вірменія", "Armenia", (".am",), "hy", "🇦🇲", "asia",
     ("вірмені",), (), (), ()),
    ("az", "Азербайджан", "Azerbaijan", (".az",), "az", "🇦🇿", "asia",
     ("азербайджан",), (), (), ()),
    ("kz", "Казахстан", "Kazakhstan", (".kz",), "kk", "🇰🇿", "asia",
     ("казахстан",), (), (), ()),
    ("uz", "Узбекистан", "Uzbekistan", (".uz",), "uz", "🇺🇿", "asia",
     ("узбекистан",), (), (), ()),
    ("kg", "Киргизстан", "Kyrgyzstan", (".kg",), "ky", "🇰🇬", "asia",
     ("киргиз",), (), (), ()),
    ("tj", "Таджикистан", "Tajikistan", (".tj",), "tg", "🇹🇯", "asia",
     ("таджикистан",), (), (), ()),
    # ------------------------ Північна Америка ----------------------------
...
# чим не збігається, а в SEO так пишуть постійно, тому це виняток. «рф» —
# однозначна кирилична абревіатура Росії, теж безпечний виняток.
_SAFE_SHORT_SYNONYMS = frozenset({"uk", "рф"})


# Про 2-літерні КОДИ країн («fr», «de», «us»…). Вони дозволені лише В КОНТЕКСТІ
# СПИСКУ (кома/плюс/«країн» або поряд уже є впізнані країни) — це вмикає
# resolver.find_all_countries через allow_short. У суцільній прозі коди мовчать,
# щоб «in/is/it» не давали хибних збігів (правило 42c9a86).
